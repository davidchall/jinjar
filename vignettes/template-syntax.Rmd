...
The syntax is very similar to that of the Jinja Python package, but there are also many differences -- some are obvious and some are subtle.
This vignette can act as a reference when writing templates.
