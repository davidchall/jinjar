...
```{jinjar, jinjar_lang="html", jinjar_config=jinjar_config(trim_blocks = TRUE, lstrip_blocks = TRUE)}
<div>
    {% if true %}
        yay
    {% endif %}
...
```{jinjar, jinjar_lang="html", jinjar_config=jinjar_config(line_statement="#"), data=params}
<ul id="navigation">
# for item in navigation
    <li><a href="{{ item.href }}">{{ item.caption }}</a></li>
# endfor
